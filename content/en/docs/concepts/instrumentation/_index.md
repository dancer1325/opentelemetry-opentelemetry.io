...
* system [observable](../observability-primer.md#what-is-observability)
  * ⚠️requirements⚠️
    * be instrumented
      * == system's components code MUST emit [signals]
        * [traces],
        * [metrics],
        * [logs]

* ways to instrument your code -- via -- OpenTelemetry
  1. [Code-based solutions](code-based)
     * -- via -- official [APIs and SDKs](../../languages)
